    ...
    <?php if (get_Option('permalink_structure')) : ?>
        <tr>
            ...
            <td>
                <div class="input-row">
                    ...
                    <div class="input-element"><input type="text" value="<?php echo esc_Attr(Post_Type_Labels::getArchiveSlug()) ?>" <?php disabled(true) ?>></div>
        ...
        <tr>
            ...
            <td>
                <div class="input-row">
                    <div><?php echo trailingslashit(Home_Url('/')) ?></div>
                    <div class="input-element"><input type="text" value="<?php echo esc_Attr(Post_Type_Labels::getItemSlug()) ?>" <?php disabled(true) ?>></div>
                ...
                <?php else : ?>
                    <p class="help">
                        ...
                        <?php if ($taxonomies = Post_Type::getAssociatedTaxonomies()) : $taxonomies = Array_Map(function ($taxonomy) {
