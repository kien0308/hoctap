...
?>
<p>
    <?php printf(I18n::__('Please choose the taxonomies you want to use for your %s.'), Post_Type_Labels::getItemPluralName()) ?>
        ...
        <tr>
            ...
            <td>
                <label for="register_<?php echo $taxonomy->name ?>_taxonomy_for_encyclopedia">
                    ...
                    <?php endif ?>
                    <?php printf(I18n::__('Use this taxonomy for %s.'), Post_Type_Labels::getItemPluralName()) ?>
                    <?php if ($taxonomy->name != 'encyclopedia-tag') Mocking_Bird::printProNotice('unlock') ?>
                </label>
                <p class="help">
                    <?php printf(I18n::__('Enables %1$s for %2$s.'), $taxonomy->label, Post_Type_Labels::getItemPluralName()) ?>
