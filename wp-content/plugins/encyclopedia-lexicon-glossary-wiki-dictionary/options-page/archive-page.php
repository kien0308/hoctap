...
<table class="form-table">
    ...
    <tr>
        ...
        <td>
            ...
            <p class="help">
                <?php printf(I18n::__('This option affects all %s archive pages.'), Post_Type_Labels::getEncyclopediaType()) ?>
                <?php printf(I18n::__('You can use "-1" to disable the pagination and show all %s in one page.'), Post_Type_Labels::getItemPluralName()) ?>
            </p>
        </td>
    </tr>
