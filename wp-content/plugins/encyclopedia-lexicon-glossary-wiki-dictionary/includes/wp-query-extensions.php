...
abstract class WP_Query_Extensions
{
    ...
    public static function filterQuery(WP_Query $query): void
    {
        if (!$query->get('suppress_filters') && !$query->is_Feed()) {
            ...
            if ($query->get('post_type') == Post_Type::post_type_name) {
            ...
            if (!is_Admin() && $query->is_Main_Query()) {
                ...
                if ($query->is_Post_Type_Archive(Post_Type::post_type_name))
            ...
            if ($include_entries) {
                ...
                if (!in_Array(Post_Type::post_type_name, $post_types))
                    $post_types[] = Post_Type::post_type_name;
